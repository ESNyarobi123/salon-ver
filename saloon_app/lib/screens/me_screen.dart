...
class _MeScreenState extends State<MeScreen>
  ...
  Widget _buildUnlinkedBanner(dynamic user) {
    final code =
        user.globalWaiterNumber ?? SalonStrings.staffNumberUnavailable;
    return GlassCard(
      ...
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      SalonStrings.meQrSectionSubtitle,
                      style: GoogleFonts.poppins(
                        fontSize: 11,
                        color: Colors.white.withValues(alpha: 0.5),
                      ),
          ...
          Material(
            ...
            child: InkWell(
              onTap: () => Share.share(
                '${SalonStrings.meShareQrMessagePrefix}${user.waiterQrUrl}',
                subject: SalonStrings.meShareQrSubject,
              ),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Text(
                SalonStrings.meEarningsSection,
                style: GoogleFonts.poppins(
                  fontSize: 14,
                  fontWeight: FontWeight.w700,
                  color: Colors.white,
          ...
          Text(
            SalonStrings.meTipsTotalSubtitle,
            style: GoogleFonts.poppins(
              fontSize: 12,
              color: Colors.white.withValues(alpha: 0.5),
            ),
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 6),
              Text(
                SalonStrings.meCustomerReviews,
                style: GoogleFonts.poppins(
                  fontSize: 15,
                  fontWeight: FontWeight.w700,
                  color: Colors.white,
              ...
              if (_ratings.isNotEmpty)
                Text(
                  SalonStrings.meReviewCount(_ratings.length),
                  style: GoogleFonts.poppins(
                    fontSize: 11,
                    color: Colors.white.withValues(alpha: 0.4),
                  ),
      ...
      child: Column(
        children: [
          ...
          _menuItem(
            ...
            title: user.restaurantName ?? SalonStrings.meDefaultRestaurant,
            subtitle: SalonStrings.meWorkplace,
            iconColor: AppTheme.secondary,
          ),
          _divider(),
          _menuItem(
            icon: Icons.notifications_outlined,
            title: SalonStrings.meNotifications,
            subtitle: SalonStrings.meNotificationsSub,
            iconColor: const Color(0xFFFBBF24),
          ),
          _divider(),
          _menuItem(
            icon: Icons.info_outline_rounded,
            title: SalonStrings.meAbout,
            subtitle: SalonStrings.meAboutSub,
