...
class _IncomingCallScreenState extends State<IncomingCallScreen>
                  ...
                  child: FadeTransition(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          isBill
                              ? SalonStrings.callBillRequest
                              : SalonStrings.callCustomerCalling,
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                '${SalonStrings.callIncoming}$dots',
                style: GoogleFonts.poppins(
                  fontSize: 14,
  ...
  Widget _buildTableInfo(Color accentColor) {
    final hasTable =
        widget.call.tableNumber != null && widget.call.tableNumber!.isNotEmpty;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            SalonStrings.requestTableDisplay(widget.call.tableNumber),
            style: GoogleFonts.poppins(
              fontSize: 16,
  ...
  Widget _buildTimeInfo(DateTime created) {
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          minutesAgo == 0
              ? SalonStrings.callJustNow
              : SalonStrings.callMinutesAgo(minutesAgo),
          style: GoogleFonts.poppins(
            fontSize: 13,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            SalonStrings.callQueueWaiting(count),
            style: GoogleFonts.poppins(
              fontSize: 12,
              fontWeight: FontWeight.w600,
      ...
      child: Row(
        ...
        children: [
          ...
          _callButton(
            ...
            label: SalonStrings.callDecline,
