...
class _DashboardScreenState extends State<DashboardScreen> {
                                      ...
                                      Expanded(
                                        child: Text(
                                          user.restaurantLocation ??
                                              SalonStrings.dashUnknownLocation,
                                          style: GoogleFonts.poppins(
                                            fontSize: 11,
                                            color: Colors.white70,
                                          ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        SalonStrings.dashShareWithManager,
                        style: GoogleFonts.poppins(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                      ...
                      Text(
                        SalonStrings.dashShareCodeHint,
                        style: GoogleFonts.poppins(
                          fontSize: 11,
  ...
  Widget _buildStatusToggle() {
    ...
    final statusLabel =
        isOnline ? SalonStrings.dashOnline : SalonStrings.dashOffline;
  ...
  void _showStatusToggleDialog(bool currentlyOnline) {
    ...
    final title =
        goingTo ? SalonStrings.dashGoOnlineTitle : SalonStrings.dashGoOfflineTitle;
    final message = goingTo
        ? SalonStrings.dashGoOnlineBody
        : SalonStrings.dashGoOfflineBody;
    final actionLabel =
        goingTo ? SalonStrings.dashGoOnline : SalonStrings.dashGoOffline;
  ...
  Future<void> _toggleStatus(bool goOnline) async {
    ...
    if (success) {
      showAppToast(
        context,
        message: goOnline
            ? SalonStrings.dashNowOnline
            : SalonStrings.dashNowOffline,
        subtitle: goOnline
            ? SalonStrings.dashNowOnlineSub
            : SalonStrings.dashNowOfflineSub,
        type: goOnline ? ToastType.success : ToastType.warning,
      );
    } else {
      showAppToast(
        context,
        message: SalonStrings.dashStatusUpdateFail,
        subtitle: SalonStrings.dashStatusUpdateFailSub,
              ...
              children: [
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        SalonStrings.requestTableDisplay(r.tableNumber),
                        style: GoogleFonts.poppins(
                          fontWeight: FontWeight.w700,
                          fontSize: 11,
                          color: Colors.white,
                ...
                Text(
                  SalonStrings.requestTypeLabel(r.type),
                  style: GoogleFonts.poppins(
                    fontSize: 10,
                    color: Colors.white.withValues(alpha: 0.8),
                  ),
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                SalonStrings.dashNewBookingsSection,
                style: GoogleFonts.poppins(
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
                  color: Colors.white,
          ...
          GlassCard(
            child: Center(
              child: Padding(
                ...
                child: Text(
                  SalonStrings.dashNoNewBookings,
                  style: GoogleFonts.poppins(
                    color: Colors.white.withValues(alpha: 0.5),
                    fontSize: 15,
                  ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            SalonStrings.dashBookingLine(o.id),
                            style: GoogleFonts.poppins(
                              fontWeight: FontWeight.w700,
                              fontSize: 13,
                              color: Colors.white,
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                SalonStrings.dashMotivationSection,
                style: GoogleFonts.poppins(
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
                  color: Colors.white,
