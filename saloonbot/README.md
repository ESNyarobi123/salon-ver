...
WhatsApp bot ya TIPTAP kwa **saloon** (bookings, huduma, bidhaa, malipo). Maneno ya mteja yako yapo `src/lang.js` (Kingereza / Kiswahili), API bado hutumia `restaurant_id`, `waiter_id`, `table_number`, nk.
