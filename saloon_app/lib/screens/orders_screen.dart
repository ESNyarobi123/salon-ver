...
class _OrdersScreenState extends State<OrdersScreen>
  ...
  String _statusLabel(String status) {
    switch (status.toLowerCase()) {
      case 'ready':
        return SalonStrings.statusReady;
      case 'preparing':
      case 'preparation':
        return SalonStrings.statusInProgress;
      default:
        return SalonStrings.statusPending;
    }
  }
              ...
              children: [
                ...
                if (newCount > 0) ...[
                  ...
                  Container(
                    ...
                    child: Text(
                      SalonStrings.newCountBadge(newCount),
                      style: GoogleFonts.poppins(
                        fontSize: 11,
                    ...
                    Tab(
                      child: Row(
                        ...
                        children: [
                          ...
                          const Text(SalonStrings.tabNew),
                          if (newCount > 0) ...[
                            const SizedBox(width: 6),
                            Container(
                              width: 20,
                    ...
                    Tab(
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 6),
                          const Text(SalonStrings.tabMine),
                        ],
                      ),
                    ),
                  ],
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              SalonStrings.noNewBookingsHint,
              style: GoogleFonts.poppins(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            SalonStrings.seatLabel(o.tableNumber),
                            style: GoogleFonts.poppins(
                              fontWeight: FontWeight.w700,
                              fontSize: 12,
                              color: Colors.white,
                  ...
                  children: [
                    ...
                    if (itemCount > 3)
                      Padding(
                        ...
                        child: Text(
                          SalonStrings.moreItems(itemCount - 3),
                          style: GoogleFonts.poppins(
                            fontSize: 11,
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (success && mounted) {
                      showAppToast(
                        context,
                        message: SalonStrings.claimToastMessage(o.id),
                        subtitle: SalonStrings.claimToastSubtitle,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text(
                      SalonStrings.readyToServeBanner,
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        fontWeight: FontWeight.w700,
                        letterSpacing: 1,
