              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      SalonStrings.tipsRecentHistory,
                      style: GoogleFonts.poppins(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                              ...
                              children: [
                                ...
                                if (t.orderId != null)
                                  Container(
                                    ...
                                    child: Text(
                                      SalonStrings.tipsBookingRef(
                                        t is TipItem ? t.orderId : null,
                                      ),
                                      style: GoogleFonts.poppins(
                                        color: Colors.white.withValues(
                                          alpha: 0.9,
