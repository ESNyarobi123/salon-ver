                    ...
                    if (_billCount > 0) ...[
                      Expanded(
                        child: _summaryChip(
                          ...
                          label: SalonStrings.requestsTabBills,
                          count: _billCount,
                          gradient: const LinearGradient(
                            colors: [Color(0xFFF43F5E), Color(0xFFE11D48)],
                          ),
                    ...
                    if (_callCount > 0)
                      Expanded(
                        child: _summaryChip(
                          ...
                          label: SalonStrings.requestsTabCalls,
                          count: _callCount,
                          gradient: const LinearGradient(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      SalonStrings.requestsAllCaughtUp,
                      style: GoogleFonts.poppins(
                    ...
                    Text(
                      SalonStrings.requestsEmptyHint,
                      style: GoogleFonts.poppins(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  SalonStrings.requestTableDisplay(
                                    r.tableNumber,
                                  ),
                                  style: GoogleFonts.poppins(
